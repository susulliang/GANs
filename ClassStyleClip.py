...
def imread(url, max_size=128, mode=None):
...
def style_clip_draw(prompt, style_path,
                    num_paths=64, num_iter=1000, max_width=16,
                    num_augs=2, style_opt_freq=5, style_opt_iter=50,
...
img = style_clip_draw('circles and coca cola', '/images/dezzy.JPG',\
                          num_iter=10, style_opt_freq=10, style_opt_iter=0, debug=False)
